...
![Age Distribution by Risk Level](../outputs/images/age_distribution.png){#fig-age-distrib}
...
![Predicted Probabilities Across Blood Sugar Levels](../outputs/images/blood_sugar_plot.png){#fig-blood-sugar width=70%}
...
![Random Forest Feature Importances](../outputs/images/rf_feature_importance.png){#fig-rf-feat-importance width=70%}
...
![ML Model Accuracies (%)](../outputs/images/accuracy_comparison.png){#fig-accuracy-comparison width=80%}
